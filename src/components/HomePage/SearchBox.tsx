            ...
            <div className="container mx-auto">
              ...
              <div className="relative">
                <div className="flex items-center border-b-2 border-primary focus-within:border-extra transition-colors">
                  <Icon path={mdiMagnify} size={1} className="text-gray-500 mr-2" />
                  <input 
                    type="text" 
                ...
                {searchValue.trim() !== '' && (
                  <div className="mt-6">
                    <h4 className="text-sm text-gray-500 mb-2">Kết quả ({filteredResults.length})</h4>
                    
                    {filteredResults.length === 0 ? (
                      <p className="text-gray-500 italic">Không tìm thấy kết quả nào phù hợp.</p>
                    ) : (
